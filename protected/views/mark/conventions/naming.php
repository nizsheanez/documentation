...
- Начальные и конечные фигурные скобки(функций, if, swich, for, foreach, …) должны располагаться на новой строке.
- Имена классов не должны начинаться с префикса «С», т.к. с него начинаются классы фреймворка.
- Любые решения при разработке, которые вызывают сомнения или трудности, нужно согласовывать с другими программистами: звонить, писать, обсуждать, советоваться. При необходимости можно организовать «Мозговой Штурм» или «Парное Программирование».
